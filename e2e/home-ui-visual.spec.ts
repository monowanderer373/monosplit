...
test('renders the real home composition at phone widths', async ({ page }) => {
  ...
  await expect(page.getByRole('navigation', { name: 'Primary navigation' }).getByRole('button', { name: '日常' })).toBeVisible()
  await expect(page.getByRole('navigation', { name: 'Primary navigation' }).getByRole('button', { name: '分析' })).toBeVisible()
  await expect(page.getByRole('navigation', { name: 'Primary navigation' }).getByRole('button', { name: '共享' })).toBeVisible()
  await expect(page.getByRole('navigation', { name: 'Primary navigation' }).getByRole('button', { name: '我的' })).toBeVisible()
  ...
  await expect(page.getByRole('navigation', { name: 'Primary navigation' }).getByRole('button', { name: '日常' })).toHaveAttribute('aria-current', 'page')
})
