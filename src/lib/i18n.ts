...
const translations = {
  ...
  'home.addAccount': { en: 'Add account', zh: '添加账户' },
  'home.addAccountTitle': { en: 'Add a cash account', zh: '添加现金账户' },
  'home.accountName': { en: 'Account name', zh: '账户名称' },
  'home.accountType': { en: 'Account type', zh: '账户类型' },
  'home.accountType.cash': { en: 'Cash', zh: '现金' },
  'home.accountType.bank': { en: 'Bank', zh: '银行' },
  'home.accountType.ewallet': { en: 'eWallet', zh: '电子钱包' },
  'home.accountCurrency': { en: 'Currency', zh: '货币' },
  'home.openingAmount': { en: 'Opening balance (optional)', zh: '期初余额（可选）' },
  'home.openingDate': { en: 'Balance as of (optional)', zh: '余额日期（可选）' },
  'home.openingHelp': {
    en: 'Leave both blank if you do not know the opening balance. Blank is not treated as zero.',
    zh: '如果还不知道期初余额，两项都留空。留空不会当成零。',
  },
  'home.openingPair': { en: 'Enter both an opening balance and a date, or leave both blank.', zh: '请同时填写期初余额和日期，或两项都留空。' },
  'home.createAccount': { en: 'Create account', zh: '创建账户' },
  'home.creatingAccount': { en: 'Creating account…', zh: '正在创建账户…' },
  'home.updating': { en: 'Updating…', zh: '正在更新…' },
  ...
  'nav.daily': { en: 'Daily', zh: '日常' },
  'nav.insights': { en: 'Insights', zh: '分析' },
  'nav.shared': { en: 'Shared', zh: '共享' },
  'nav.me': { en: 'Me', zh: '我的' },
